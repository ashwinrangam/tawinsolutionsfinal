  ...
  return (
    <section ref={sectionRef} id="about" className="relative min-h-screen py-24 overflow-hidden bg-gradient-to-b from-black to-background/95">
      ...
      >
        ...
        >
          ...
          >
            <motion.span 
              ...
              initial={{ y: 50 }}
              animate={isTitleInView ? { y: 0 } : { y: 50 }}
        ...
        {/* Final quote with enhanced visibility and animations */}
        <motion.div 
          className="max-w-3xl mx-auto text-center mb-16 relative py-12"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: false, margin: "-20% 0px" }}
          transition={{ duration: 1.2 }}
        >
          ...
          <motion.div
            className="absolute inset-0 rounded-3xl bg-gold/5 -z-10"
            animate={{
              boxShadow: [
                "0 0 20px 0px rgba(212, 175, 55, 0.1)",
          ...
          {/* Quotation mark */}
          <motion.div 
            className="text-6xl text-gold/20 font-serif absolute top-0 left-4"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: false }}
          ...
          <motion.p 
            className="text-xl md:text-2xl text-gray-100 italic font-light px-8"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: false }}
          ...
          <motion.div 
            className="text-6xl text-gold/20 font-serif absolute bottom-0 right-4"
            initial={{ opacity: 0, y: -20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: false }}
            transition={{ duration: 0.8, delay: 0.3 }}
          ...
          {/* Animated underline */}
          <motion.div 
            className="h-[1px] bg-gradient-to-r from-transparent via-gold/40 to-transparent absolute bottom-6 left-1/2 -translate-x-1/2"
            initial={{ width: "0%" }}
