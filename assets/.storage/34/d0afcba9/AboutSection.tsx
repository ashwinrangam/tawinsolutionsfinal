...
// Updated milestone to reflect the company being founded in 2024
const milestones = [
  {
    year: "2024",
  ...
  },
  {
    ...
    description: "Defined our core mission to empower organizations through strategic technology consulting."
  },
  {
    year: "2024 Q2",
    title: "Service Framework",
    description: "Developed our three-pillar service framework covering team augmentation, cloud technology, and business transformation."
  },
  {
    year: "2024 Q3",
    title: "Market Entry",
    description: "Officially launched our services and began establishing partnerships with key technology providers."
  },
  {
    year: "Future Vision",
    title: "Growth Roadmap",
    description: "Strategic expansion into global markets and deepening our expertise in AI and cloud technologies."
  }
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Discover our journey of innovation and excellence in technology consultancy.
          </p>
        </motion.div>
