...
import PremiumAboutSection from '../components/layout/PremiumAboutSection';
import TeamSection from '../components/layout/TeamSection';
import PremiumContactSection from '../components/layout/PremiumContactSection';
import Footer from '../components/layout/Footer';
import { PremiumScrollProvider } from '../components/ui/PremiumScrollProvider';
  ...
  return (
    <PremiumScrollProvider>
      <div className="min-h-screen bg-black text-foreground relative overflow-hidden">
        ...
        {/* Page content with premium animations */}
        <div className="relative z-10">
          <Navbar />
          <HeroSection />
          <ServicesSection />
          {/* Premium scrollytelling components */}
          <PremiumAboutSection />
          <TeamSection />
