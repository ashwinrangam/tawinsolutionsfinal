          ...
          <Card className="border border-border/50 shadow-lg relative overflow-hidden">
            ...
            <CardContent className="pt-8 pb-4">
              <div className="flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-16 h-16 text-gold/20">
            ...
            <CardFooter className="flex flex-col items-center pb-8 pt-4 space-y-3">
