...
interface ProgressAnimProps {
  ...
  className?: string;
  style?: React.CSSProperties;
  from?: any; // Initial animation values
  to?: any; // End animation values
  transition?: any; // Transition properties
}
...
export const ProgressAnim: React.FC<ProgressAnimProps> = ({ 
  ...
  Object.keys(from).forEach(key => {
    if (typeof from[key] === 'number' && typeof to[key] === 'number') {
      animateValues[key] = from[key] + (to[key] - from[key]) * elementProgress;
    }
  });
