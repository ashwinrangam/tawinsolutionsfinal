...
export default function ContactSection() {
  ...
  const contentY = useTransform(scrollY, [0, 1000], [50, 0]);
  ...
  const floatingElements = [
    ...
    { bottom: "20%", left: "15%", size: "150px", color: "rgba(212, 175, 55, 0.03)", transform: bgY2 },
  ];
  ...
  return (
    <section ref={sectionRef} id="contact" className="section-padding bg-gradient-to-b from-secondary/30 to-background relative overflow-hidden">
      {/* Parallax background effect */}
      <motion.div 
        className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1557682250-f4ba2a6f9f2e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2129&q=80')] opacity-[0.03] bg-cover bg-center"
        style={{ y: bgY1 }}
      />
      ...
      >
        ...
        >
          ...
          <div className="absolute w-40 h-40 rounded-full bg-gold/[0.03] -z-10 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
        ...
        >
          ...
          <div className="bg-card rounded-lg shadow-xl p-8 border border-gold/30 relative overflow-hidden">
